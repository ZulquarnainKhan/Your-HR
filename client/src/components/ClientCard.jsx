...
const ClientCard = ({ imgURL, type, label, subtext }) => {
    return (
        ...
        <section className='flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100'>
            ...
            <div className="flex  items-center bg-white border border-gray-200  max-md:flex-row md:max-w-xl hover:bg-gray-100 ">

                <img className="object-cover w-full border border-gray-200 rounded-t-lg h-96 max-sm:hidden md:w-48 md:rounded-none md:rounded-s-lg " src={imgURL} alt="" />
