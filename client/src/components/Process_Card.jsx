...
const ProcessCard = ({imgURL,label,subtext}) => {
  return (
    <section className='flex-col items-center justify-center sm:w-[350px] sm:min-w-[350px] rounded-[20px] process_section'>
        <div className=' w-full h-11 flex justify-center  rounded-full '>
            <img src={imgURL} alt={label} className='flex w-[150px] h-[150px] justify-center items-center process_img' />
