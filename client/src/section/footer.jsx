    ...
    return (
        <footer id="contact" className="">
            <div className="relative_box flex justify-between mx-36 max-md:mx-0 max-md:w-full  bg_grad h-[300px] w-auto">
                <img src={footer_img} width={350} height={600} className="px-8 footer_img max-lg:hidden" />
                
                <div className="text-center pr-16 pt-8 max-md:pr-0 max-md:mx-4" style={{ color: "white" }}>
                    <h2 className="font-palanquin text-3xl max-lg:text-xl lg:text-xl text-bold capitalise font-bold lg:max-w-lg max-[300px]:mb-10 ">
                        We Want To Give You The Best Service
                    </h2>

                    <p className="font-montserrat about_desc_text text-lg lg:text-[10px] mt-6 mb-6  max-[300px]:hidden max-[300px]: sm:max-w-sm max-md:text-[10px]" style={{ color: "white" }}>We are 100+ professional software engineers with more than 10 years of experience in delivering superior products Beleive it because you have seen it. Here are the real numbers</p>
            ...
            <div className={`flex justify-between items-start mb-24 gap-20 flex-wrap max-lg:flex-col `}>
                <div className="flex flex-col items-start">
                    ...
                    <h1 className="text-3xl font-bold">YOUR-HR</h1>
